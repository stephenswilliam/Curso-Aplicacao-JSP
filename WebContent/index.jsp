...
<body>
<!-- Exemplos de utiliza��o da biblioteca JSTL, declarada no in�cio da p�gina -->
	<!--out Exibe na p�gina -->
	...
	<!-- set declara uma vari�vel valida durante a p�gina, sess�o... -->
	<c:set var="calc" value="${500*3}" scope="page"></c:set>
	<c:out value="${calc}"></c:out>
	
	<!-- remove remove uma vari�vel declarada anteriormente -->
	<c:remove var="calc"/>
	<c:out value="${calc}"></c:out>
	...
	<br>
	<c:out value="valor de flag �: ${flag * 2}"/>
	
	
	
	<form action="ServletLogin" method="post">
		<br>
		Usu�rio: <input type="text" id="login" name="login" placeholder="usu�rio" ><br><br>
